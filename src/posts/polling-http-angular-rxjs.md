...
tags: ['angular', 'rxjs']
ogType: 'article'
imageUrl: '/post_images/polling-http-angular-rxjs.png'
imageAlt: 'Screenshot of custom RxJS operator'
---

![Screenshot of custom RxJS operator](/post_images/polling-http-angular-rxjs/header-image.png)
